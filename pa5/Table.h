...
// add private data and methods here
  ...
  // return the size of the longest chain in table
  int getMaxChainSize() const;

  // initialize the value of pointer array to null
  void initializeTable(ListType *&table);
