...
public class MazeViewer2 {
    ...
    boolean[][] mazeData = {{false,true,true,true},{false,false,false,false},{true,true,true,false}};
    MazeCoord startLoc = new MazeCoord(0, 0);
    MazeCoord exitLoc = new MazeCoord(2, 3);
    Maze maze = new Maze(mazeData, startLoc, exitLoc);
    
    MazeComponent mazeDisplay = new MazeComponent(maze);

    JFrame frame = new JFrame();
    frame.setSize(FRAME_WIDTH, FRAME_HEIGHT);
    frame.setTitle("MazeSearch");
